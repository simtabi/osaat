<#
.SYNOPSIS
  osaat installer for Windows.

.EXAMPLE
  irm https://opensource.simtabi.com/install/osaat.ps1 | iex

.EXAMPLE
  # Pin a version / custom dir (env vars are prefixed with the uppercased binary name)
  $env:OSAAT_VERSION = 'v0.1.0'; irm https://.../install.ps1 | iex
#>
#Requires -Version 5
[CmdletBinding()]
param(
...
# Bare, ready-to-run executable: osaat_windows_<arch>.exe.
